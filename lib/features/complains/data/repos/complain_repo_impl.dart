...
class ComplainRepoImpl extends ComplainRepo {
  ...
  @override
  Future<Either<Failure, ComplainDetailsEntity>> getComplainById(String complainId) async {
    try {
      ComplainDetailsEntity complain = await complainsDatasource.getComplainById(complainId);
  ...
  @override
  Future<Either<Failure, ComplainDetailsEntity>> openComplain(String complainId) async {
    try {
      ComplainDetailsEntity complain = await complainsDatasource.openComplain(complainId);
      return Right(complain);
    } on Exception catch (e) {
      if (e is DioException) {
        return Left(ServerFailure.fromDioError(e));
