...
class DispatchedDeliveryOrder extends Equatable {
  final String? id;
  final String? podNo;
  ...
  factory DispatchedDeliveryOrder.fromJson(Map<String, dynamic> json) {
    return DispatchedDeliveryOrder(
