...
import 'package:wncc_portal/features/reports/dispatch_details/presentation/views/widgets/dispatch_per_sales_body.dart';
import 'package:wncc_portal/features/user/presentation/manager/cubits/user_cubit/user_cubit.dart';

class DispatchPerSalesPage extends StatelessWidget {
  const DispatchPerSalesPage({super.key});

  @override
  Widget build(BuildContext context) {
    BlocProvider.of<DispatchDetailsPerSalesCubit>(context)
        .getDispatchDetailsPerSales(DateTime.now(), DateTime.now());
        ...
        if (state is UserSuccess) {
          return SafeArea(
            child: Scaffold(
              ...
              body: const DispatchPerSalesBody(),
            ),
          );
        }
