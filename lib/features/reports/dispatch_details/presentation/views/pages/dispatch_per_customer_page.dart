...
import 'package:wncc_portal/features/reports/dispatch_details/presentation/views/widgets/dispatch_per_customer_body.dart';
import 'package:wncc_portal/features/user/presentation/manager/cubits/user_cubit/user_cubit.dart';

class DispatchPerCustomerPage extends StatelessWidget {
  const DispatchPerCustomerPage({super.key});

  @override
  Widget build(BuildContext context) {
    BlocProvider.of<DispatchDetailsPerCustomerCubit>(context)
        .getDispatchDetailsPerCustomer(DateTime.now(), DateTime.now());
        ...
        if (state is UserSuccess) {
          return SafeArea(
            child: Scaffold(
              ...
              body: const DispatchPerCustomerBody(),
            ),
          );
        }
