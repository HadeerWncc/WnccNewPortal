...
import 'package:wncc_portal/features/reports/pending/presentation/views/widgets/pending_page_body.dart';
...
class PendingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<PendingCubit>(context).getPendingDelivery();
