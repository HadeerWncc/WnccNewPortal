...
import 'package:wncc_portal/features/reports/payment/presentation/views/widgets/balance_payments_body.dart';
import 'package:wncc_portal/features/user/presentation/manager/cubits/user_cubit/user_cubit.dart';

class PaymentsBalancePage extends StatelessWidget {
  const PaymentsBalancePage({super.key});
        ...
        if (state is UserSuccess) {
          return SafeArea(
            child: Scaffold(
              ...
              body: const BalancePaymentsBody(),
            ),
          );
        }
