...
import 'package:wncc_portal/features/reports/dispatch_details_2.dart/presentation/views/widgets/dispatch_details_vs_per_cust_body.dart';
import 'package:wncc_portal/features/user/presentation/manager/cubits/user_cubit/user_cubit.dart';

class DispatchDetailsV2PerCustPage extends StatelessWidget {
  const DispatchDetailsV2PerCustPage({super.key});
    ...
    return BlocConsumer<UserCubit, UserState>(
      ...
      builder: (context, state) {
        if (state is UserSuccess) {
          BlocProvider.of<DispatchDetailsV2PerCustomerCubit>(context)
              .getDispatchDetailsV2PerCustomer(DateTime.now(), 0, state.user);
          return SafeArea(
            child: Scaffold(
              appBar: AppBar(
              ...
              body: DispatchDetailsVsPerCustBody(
                user: state.user,
              ),
            ),
          );
