...
class DispatchDetailsV2PerSalesCubit
    extends Cubit<DispatchDetailsV2PerSalesState> {
  DispatchDetailsV2PerSalesCubit(this.dispatchDetailsRepo)
      : super(DispatchDetailsV2PerSalesInitial());
