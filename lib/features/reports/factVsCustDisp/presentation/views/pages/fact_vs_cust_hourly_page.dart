...
import 'package:wncc_portal/features/reports/factVsCustDisp/presentation/views/widgets/fact_vs_cust_hourly_body.dart';
...
class FactvscustHourlypage extends StatelessWidget {
  const FactvscustHourlypage({super.key});
  @override
  Widget build(BuildContext context) {
    BlocProvider.of<FactVsCustCubit>(context)
        .getFactVsCustDisp(3, DateTime.now());
