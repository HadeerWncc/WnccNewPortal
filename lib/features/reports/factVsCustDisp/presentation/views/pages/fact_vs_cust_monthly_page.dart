...
import 'package:wncc_portal/features/reports/factVsCustDisp/presentation/views/widgets/fact_vs_cust_monthly_body.dart';
...
class FactvscustMonthlypage extends StatelessWidget {
  const FactvscustMonthlypage({super.key});

  @override
  Widget build(BuildContext context) {
    BlocProvider.of<FactVsCustCubit>(context)
        .getFactVsCustDisp(1, DateTime.now());
        ...
        if (state is UserSuccess) {
          return SafeArea(
            child: Scaffold(
              ...
              body: const FactvscustpageMonthlyBody(),
            ),
          );
        }
